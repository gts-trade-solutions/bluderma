...
export default function AuthLayout({
  ...
  return (
    <main className="flex min-h-screen">
      {/* Brand panel */}
      <aside className="relative hidden w-[42%] shrink-0 overflow-hidden on-dark bg-brand-950 lg:block">
        <div
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br on-dark from-brand-950/90 via-brand-900/80 to-teal-900/70" />
      ...
      {/* Form column */}
      <div className="flex min-h-screen flex-1 flex-col items-center justify-center bg-surface px-5 py-12 sm:px-10">
