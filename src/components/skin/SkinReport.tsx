...
export function SkinReport({
  ...
  const summaryBlock = aiSummary ? (
    <div className="rounded-lg bg-slate-50 p-3 text-[13px] leading-relaxed sm:text-sm print:bg-transparent print:px-0">
  ...
  return (
    <div className="skin-report-doc min-h-screen bg-slate-50 py-6 print:bg-white print:py-0">
      ...
      <div className="mx-auto max-w-3xl bg-white p-5 shadow-sm sm:p-8 print:p-8 print:shadow-none">
        <header className="flex items-start justify-between gap-3 border-b border-slate-200 pb-5 sm:gap-4">
        ...
        {/* Clinics — highlighted near the top (replaces product recos) */}
        {doctors.length ? (
          <section className="mt-6 break-inside-avoid rounded-2xl bg-gradient-to-br from-brand-50 to-teal-50 p-4 ring-1 ring-brand-100 print:bg-transparent print:ring-slate-200">
        ...
        <footer className="mt-10 border-t border-slate-200 pt-4 text-[11px] leading-relaxed text-ink-muted">
